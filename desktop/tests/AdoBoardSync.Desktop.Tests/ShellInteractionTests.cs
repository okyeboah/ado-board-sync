...
/// </summary>
public partial class ShellInteractionTests
{
    ...
    {
        return TempBoardProfile.Create(RepoPaths.Fixture("backlog", "standard.md"));
    }
    ...
    public void TheAgentPaneWillNotRunWithoutAPromptAndScopesItselfToTheSelection()
    {
        UiHarness.AwaitOnUiThread(async () =>
        {
            ...
            try
            {
                ...
                Assert.Equal(AgentScope.Issue, model.Agent!.Scope);
                Assert.Contains(
